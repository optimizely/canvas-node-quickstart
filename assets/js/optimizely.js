(function( $ ) {
	...
	*/
	OptimizelyAPI.prototype.call = function( type, endpoint, data, callback, error ) {
		var self = this;
	...
	OptimizelyAPI.prototype.get = function( endpoint, callback, error ) {
		this.call( 'GET', endpoint, '', callback, error );
	}

	OptimizelyAPI.prototype.post = function( endpoint, data, callback, error ) {
		this.call( 'POST', endpoint, data, callback, error );
	}

	OptimizelyAPI.prototype.put = function( endpoint, data, callback, error ) {
		this.call( 'PUT', endpoint, data, callback, error );
	}

	OptimizelyAPI.prototype.delete = function( endpoint, callback, error ) {
		this.call( 'DELETE', endpoint, '' ,callback, error );
	}
	...
	*/
	OptimizelyAPI.prototype.patch = function( endpoint, data, callback, error ) {
		var self = this;
